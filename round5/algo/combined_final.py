...
class Trader:
    ...
    OXYGEN_OVERRIDE_PRODUCTS = set(_OxygenShakeStrategy.TRADED)
    ...
    OVERRIDE_PRODUCTS = (PEBBLES_OVERRIDE_PRODUCTS | SNACKPACK_OVERRIDE_PRODUCTS | 
                         SLEEP_POD_OVERRIDE_PRODUCTS | GALAXY_OVERRIDE_PRODUCTS | 
                         ROBOT_OVERRIDE_PRODUCTS | MICROCHIP_OVERRIDE_PRODUCTS |
                         OXYGEN_OVERRIDE_PRODUCTS)
    ...
    def override_strategy_orders(self, state: TradingState, data: Dict) -> Dict[str, List[Order]]:
        ...
        strategies = [
            ('oxygen', _OxygenShakeStrategy(), self.OXYGEN_OVERRIDE_PRODUCTS),
            ('pebbles', _PebblesStrategy(), self.PEBBLES_OVERRIDE_PRODUCTS), 
            ('snackpack', _SnackpackStrategy(), self.SNACKPACK_OVERRIDE_PRODUCTS), 
            ('sleep_pods', _SleepPodStrategy(), self.SLEEP_POD_OVERRIDE_PRODUCTS), 
            ('galaxy', _GalaxyStrategy(), self.GALAXY_OVERRIDE_PRODUCTS), 
            ('robot', _RobotStrategy(), self.ROBOT_OVERRIDE_PRODUCTS), 
            ('microchip', _MicrochipStrategy(), self.MICROCHIP_OVERRIDE_PRODUCTS)
        ]
