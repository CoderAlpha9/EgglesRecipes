...
# ==============================================================================
# 3. HIGH-VOLUME MINIMAX PORTFOLIO EVALUATOR
# ==============================================================================
def eval_portfolio(portfolio, buy_scores, sell_scores, greeks, n_rounds):
    ...
    # FORCED ALPHA CONSTRAINT: Portfolio MUST hold at least 200 Option Contracts
...
def optimize_portfolio(buy_scores, sell_scores, greeks, n_rounds, max_iterations=3000):
    ...
    print(f"\nRandom Start -> Max Loss Floor: {int(init_w):,} | Avg: {int(init_a):,} | Delta: {init_d:.2f}")
    print("Initiating High-Volume Minimax Optimization...\n")
        ...
        for asset in gui_order:
            ...
            for d_vol in [-1, 1]:
                if abs(portfolio[asset] + d_vol) <= max_v:
                    ...
                    # Hedged Move (Adjust Option + Instantly Offset with Underlying)
                    if asset != 'AC':
...
if __name__ == "__main__":
    ...
    init_metrics, fin_metrics, out_greeks = optimize_portfolio(buy_scores, sell_scores, greeks, n_rounds)
    
    # 2. Print Detailed Evolution Metrics (As Before)
    print("\n=====================================================================================")
    ...
    # 3. Compare to Historical Best & Save
