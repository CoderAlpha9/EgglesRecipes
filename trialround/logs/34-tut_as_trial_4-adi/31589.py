...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        # --- State Management for Microstructure ---
        trader_state = {
        ...
        for product in state.order_depths:
            ...
            # ------------------------------------------
            # 3. COMPUTE BASE FEATURES & Z-SCORES
            # ------------------------------------------
            ...
            # The Critical Feature: Microprice
            ...
            # ==========================================
            # EXECUTION: TOMATOES (Microprice Anchoring)
            # ==========================================
            if product == "TOMATOES":
                if is_warmed_up:
                ...
                # --- UPGRADE: Microprice Anchoring ---
                # We use micro_price instead of mid_price to naturally front-run order book imbalances
                fair_price = micro_price + alpha

                # --- DYNAMIC TAKER SWEEPING ---
                ...
                ideal_bid = fair_price - 1.5 - skew
                ideal_ask = fair_price + 1.5 - skew
            ...
            # ==========================================
                ...
                # EMERALDS remains anchored to the 10000 mathematical peg
                fair_price = 10000 + (alpha * 0.5)

                # --- DYNAMIC TAKER SWEEPING (Emeralds) ---
                ...
                # UPGRADE: Stricter Toxicity Defense (Lowered threshold from 0.20 to 0.15)
                if vpin > 0.15:
